...
TEST_LOG_PATH = 'test/sample_log/TiltMeasurementLog'
VALIDATION_JSON_PATH = 'test/validation_json'
VALIDATION_JSON_FILE = 'validation_tiltmeasure.json'
...
def test_analysis_get_detail_default(api):
    ...
    param = {
        ...
        "group_by": "period",
        "group_value": "1d",
        "group_selected": ["2021-01-14 00:00:00", "2021-01-15 00:00:00", "2021-01-16 00:00:00"],
