...
const GraphTwin = ({ width, height, fill, className }) => {
  return (
    <svg
    ...
    >
      <path
        ...
        style={{ transform: 'scale(0.5) translate(800px, 0px)' }}
      />
      <path
        ...
        style={{ transform: 'scale(0.5) translate(0px, 800px)' }}
      />
    </svg>
  );
};
